  ...
  return (
    <div className='h-screen'>
      <header className='bg-white shadow'>
        <div className='max-w-9xl mx-auto py-6 px-4 sm:px-6 lg:px-8 bg-gray-300'>
      ...
      <div className='flex mx-auto py-6 sm:px-6 lg:px-8 h-4/5 bg-gray-100'>
      
        <sidebar className='border-4 border-solid border-gray-200 w-1/4 mx-auto sm:px-6 lg:px-8 bg-gray-800  float-left text-gray-300'>
          {items.map((item, i) => {
            return (
              <div
                key={i}
