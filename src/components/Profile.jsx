...
function Profile() {
  ...
  return (
    <div className='flex flex-row h-full w-full p-3 items-center justify-items-stretch text-gray-600 bg-gray-300'>
      ...
      <div className='w-2/6 h-full flex flex-row justify-end'>
        <div className='border-gray-800 w-36 h-36 border-solid border-2 rounded-full bg-gray-700'>
        ...
        <div className={style}>
          <button
            className={
              'bg-pink-800 inline text-white active:bg-pink-800 font-bold uppercase text-sm px-4 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150'
            }
            type='button'
